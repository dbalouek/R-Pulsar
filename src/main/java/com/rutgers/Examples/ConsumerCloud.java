...
public class ConsumerCloud {
    ...
    public static class Consum implements Runnable {
        ...
        Consum(Message.ARMessage msg) {
            this.msg = msg;
            profile = Message.ARMessage.Header.Profile.newBuilder().addSingle("temperature").addSingle("cloud").build();
    ...
    public static void main(String[] args) throws UnknownHostException, ClassNotFoundException {
        try {
            ...
            Message.ARMessage.Header.Profile profile = Message.ARMessage.Header.Profile.newBuilder().addSingle("temperature").addSingle("cloud").build();
